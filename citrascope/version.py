"""Version detection for CitraScope, handling both PyPI and git-based installs."""
...
def get_version_info() -> VersionInfo:
    """Detect CitraScope version, install type, and git state.
    ...
    """
    try:
        base_version = pkg_version("citrascope")
