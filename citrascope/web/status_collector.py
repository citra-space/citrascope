...
Extracted from CitraScopeWebApp to keep the web app a thin container.
"""
...
from citrascope.constants import DEV_APP_URL, PROD_APP_URL
from citrascope.logging import CITRASCOPE_LOGGER
from citrascope.web.helpers import _gps_fix_to_dict, _resolve_autofocus_target_name
from citrascope.web.models import SystemStatus
