...
class AlignmentManager:
    ...
    def _do_calibration(self) -> None:
        ...
        from citrasense.hardware.devices.mount.altaz_pointing_model import generate_calibration_grid
    ...
    def _pick_verification_targets(self, mount: Any, site_lat: float, site_lon: float) -> list[tuple[float, float]]:
        ...
        """
        from citrasense.hardware.devices.mount.altaz_pointing_model import altaz_to_radec
